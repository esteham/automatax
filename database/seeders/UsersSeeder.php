...
class UsersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        User::updateOrCreate(['email'=>'taxpayer@example.com'],[
            'name'=>'Tax Payer', 'phone'=>'01800000002', 'role'=>Role::TAXPAYER,
            'password'=>Hash::make('password'),
        ]);
        User::updateOrCreate(['email'=>'auditor@example.com'],[
            'name'=>'Auditor', 'phone'=>'01800000003', 'role'=>Role::AUDITOR,
            'password'=>Hash::make('password'),
        ]);
        User::updateOrCreate(['email'=>'accountant@example.com'],[
            'name'=>'Accountant', 'phone'=>'01800000004', 'role'=>Role::ACCOUNTANT,
            'password'=>Hash::make('password'),
        ]);
